...
public class SparkSqlStreamingDemo {
	...
	private static Function<Row, String> function = new Function<Row, String>() {
		...
		public String call(Row row) {
			return "posLon: " + row.getDouble(1) + ", postLat: " + row.getDouble(0) + ", kwh: " + row.getInt(2);
		}
	};
	...
	public static void main(String[] args) {
		...
		List<ElectricConsumer> data = Arrays.asList(new ElectricConsumer(10, 49, 2, true), new ElectricConsumer(10, 47, 3, false));
		...
		List<String> activeConsumers = activeConsumersDataFrame.javaRDD().map(function).collect();
